...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4>Data Rincian Kegiatan -<strong>{{ $nama->nama }}</strong></h4>
                </div>
                <div class="col-sm-6">
                            ...
                            <table class="table table-bordered table-hover" id="tblData">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @else
                                        <td style="text-align:center"><font color="red">{{ $keg['ak1'] }}</font></td>
                                        <td style="text-align:center"><font color="red">{{ $keg['ak2'] }}</font></td>
                                        @endif
                                        <td style="text-align:center">-</td>
                                    </tr>
                                    <?php 
